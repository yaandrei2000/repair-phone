...
export const metadata: Metadata = {
	...
	description:
		'Прозрачные цены на ремонт телефонов во Владимире. Замена экрана от 3490₽, аккумулятора от 2190₽, разъема зарядки от 1790₽. Бесплатная диагностика. Гарантия 12 месяцев.',
	keywords: [
