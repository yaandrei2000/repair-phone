				...
				>
					...
					<div className='bg-card border-border/50 overflow-hidden rounded-2xl border'>
						{category.services.map((service, serviceIndex) => (
							<div
								key={serviceIndex}
								className='border-border/50 hover:bg-primary/5 flex flex-col gap-3 border-b px-5 py-4 transition-colors last:border-b-0 md:flex-row md:items-center md:justify-between md:gap-6 md:px-6 md:py-5'
							>
